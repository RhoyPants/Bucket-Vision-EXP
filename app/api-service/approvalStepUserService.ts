...
export const getUsersByRole = async (roleId: string) => {
  const res = await axiosApi.get(`/admin/approval-flows/roles/${roleId}/users`);
  return res.data;
};

// 🔹 GET ASSIGNED USERS FOR APPROVAL STEP
export const getApprovalStepUsers = async (stepId: string) => {
  const res = await axiosApi.get(`/admin/approval/steps/steps/${stepId}/users`);
  return res.data;
};
...
export const assignUsersToApprovalStep = async (
  ...
  const res = await axiosApi.post(`/admin/approval/steps/steps/${stepId}/users`, data);
  return res.data;
};
...
export const addUserToApprovalStep = async (
  ...
  const res = await axiosApi.post(`/admin/approval/steps/steps/${stepId}/users/add`, data);
  return res.data;
};
...
export const removeUserFromApprovalStep = async (
  ...
  const res = await axiosApi.delete(`/admin/approval/steps/steps/${stepId}/users/${userId}`);
  return res.data;
};

// 🔹 CLEAR ALL USER ASSIGNMENTS (REVERT TO ROLE-BASED)
export const clearApprovalStepUsers = async (stepId: string) => {
  const res = await axiosApi.delete(`/admin/approval/steps/steps/${stepId}/users`);
  return res.data;
};
