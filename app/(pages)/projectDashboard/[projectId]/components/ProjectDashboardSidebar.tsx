  ...
  const items = [
    {
      ...
      href: `/projectDashboard/${projectId}`,
      icon: <DashboardOutlinedIcon />,
    },
    {
      label: "Sprint Management",
      href: `/projectDashboard/${projectId}?view=sprint-management`,
    ...
    },
    {
      ...
      href: `/projectDashboard/${projectId}?view=project-reports`,
    ...
    >
      ...
      >
        <Box
          ...
          viewBox="0 0 160 134"
          role="img"
          aria-label={`${progress.toFixed(0)}% project progress`}
        ...
        >
          <circle
            ...
            stroke="#E5E7EB"
            strokeWidth="16"
            strokeDasharray="245 81.7"
            transform="rotate(135 80 67)"
          />
          <circle
            cx="80"
            cy="67"
            ...
            stroke="#0B74D1"
            strokeWidth="16"
            strokeDasharray={`${(245 * progress) / 100} 326.7`}
            transform="rotate(135 80 67)"
          />
          <text
            x="80"
        ...
        <Typography
          sx={{ mt: -0.5, fontSize: 12.5, color: "#475569", fontWeight: 700 }}
        >
          Status:{" "}
          <Box component="span" sx={{ color: "#16A34A", fontWeight: 900 }}>
            {status}
          </Box>
        </Typography>
      </Box>
      ...
      <Stack
        ...
        spacing={0.25}
        sx={{ p: 1.25, overflowY: "auto" }}
      >
        {items.map((item) => {
          const itemView = new URLSearchParams(
            item.href.split("?")[1] || "",
          ).get("view");
          const active =
          ...
          return (
            <Button
              ...
              sx={{
                ...
                color: active ? "#155EEF" : "#475569",
                bgcolor: active ? "#DCEBFC" : "transparent",
                boxShadow: "none",
                "& .MuiButton-startIcon": {
                  color: active ? "#2563EB" : "#64748B",
                },
                "&:hover": {
                  bgcolor: active ? "#DCEBFC" : "#EEF2F7",
                  boxShadow: "none",
                },
              }}
            >
        ...
        {canSetupProject && (
          <Button
            ...
            sx={{
              ...
              fontWeight: 800,
              boxShadow: "none",
              "&:hover": { bgcolor: "#1B169D", boxShadow: "none" },
            }}
          >
            Setup Project
          </Button>
