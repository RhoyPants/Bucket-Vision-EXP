...
import { getSubmittedReports, deleteDailyReport } from "@/app/redux/controllers/dailyReportController";
...
export default function DailySubmittedList() {
  ...
  const { submittedReports, loading } = useAppSelector((state) => state.dailyReport);
  ...
  const getReceiverReadStatus = (report: DailyReport) => {
