...
export default function AssignMemberSelect({
  ...
  const totalSelectableCount = selectedUsers.length + availableMembers.length;
  ...
  const handleSelectAll = () => {
    if (allSelected) {
      ...
      const nextUsers = [...selectedUsers, ...availableMembers];
  ...
  }, [allSelected, availableMembers, totalSelectableCount]);
